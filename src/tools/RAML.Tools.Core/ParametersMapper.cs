...
namespace AMF.Tools.Core
{
    public class ParametersMapper
    {
        ...
        {
            return new GeneratorParameter { OriginalName = parameter.Name,  Name = NetNamingMapper.RemoveInvalidChars(parameter.Name), Type = NewNetTypeMapper.GetNetType(parameter.Schema), Description = parameter.Description };
        }
